...
def _scan_patterns_cached(
    ...
    for dir_ in directions:
        ...
        wr_10j = (_stats_for_years(y10, dir_, min_t=max(int(10 * 0.8), 3)) or {}).get("wr", np.nan)
        wr_15j = (_stats_for_years(y15, dir_, min_t=max(int(15 * 0.8), 3)) or {}).get("wr", np.nan)
        ...
        if forecast_df.empty:
            ...
            forecast_fig.add_trace(
                go.Scatter(
                    ...
                    y=forecast_df["high"],
                    mode="lines",
                    line={"color": "rgba(98,200,232,.25)", "width": 1, "shape": "spline", "smoothing": 0.55},
